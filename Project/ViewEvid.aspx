<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ViewEvid.aspx.cs" Inherits="ViewEvid" %>
...
<asp:Content ID="Body" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label9" runat="server" Font-Size="X-Large" Font-Underline="True" 
        ForeColor="#196BA1" Text="View Evidence"></asp:Label>
    <br />
    <br />
    <br />
